...
MDN is a chat bot built on the [Hubot][hubot] framework. It was
...
You can start MDN locally by running:
...
Then you can interact with MDN by typing `MDN help`.

    MDN> MDN help
    MDN animate me <query> - The same thing as `image me`, except adds [snip]
